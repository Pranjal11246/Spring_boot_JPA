...
public class AuthorRepository__BeanDefinitions {
  ...
  public static BeanDefinition getAuthorRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, AuthorRepository.class, Author.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.alibucoding.jpa.Repositories.AuthorRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.alibucoding.jpa.Repositories.AuthorRepositoryImpl__AotRepository(entityManager, context));
      }
    });
